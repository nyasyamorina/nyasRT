...
public:
    ...
    template<class U> CONST_FUNC vec2 & reflect(vec2<U> const& n) noexcept
    {
...
template<class T, class U> vec2<std::common_type_t<T, U>> reflect(vec2<T> const& v, vec2<U> const& n) noexcept
{
